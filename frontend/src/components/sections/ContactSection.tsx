          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 mt-2">
              <button 
                ...
                className="px-6 py-3 bg-brand-silver/5 border border-white/10 rounded-full hover:bg-brand-silver hover:text-black hover:border-brand-silver transition-all duration-500 flex items-center justify-center gap-3 w-full sm:w-[220px] text-sm text-gray-300 hover:shadow-[0_0_20px_rgba(230,236,245,0.3)] outline-none group"
              >
              ...
              <a 
                ...
                className="px-6 py-3 bg-gradient-to-r from-brand-silver/5 to-transparent border border-white/20 rounded-full hover:bg-brand-silver hover:border-brand-silver text-gray-300 hover:text-black transition-all duration-500 flex items-center justify-center gap-2 w-full sm:w-[220px] text-sm outline-none font-mono uppercase tracking-widest text-[10px] group/save shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:shadow-[0_0_20px_rgba(230,236,245,0.4)] relative overflow-hidden"
              >
